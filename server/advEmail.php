...
/*
  ...
  *   
  *   $advEmail->from('noreply@example.com', 'Example Example');
  *   
  *   $advEmail->to('example@example.com');
  *   //$advEmail->cc('example@example.com');
  *   //$advEmail->bcc('example@example.com');
  *   
  ...
  */
  ...
  class advEmail
  {
    ...
    private $_smtpUser      = '';
    private $_systemEmail   = 'noreply@pistolmedia.com';
    private $_subject       = '';
    private $_userAgent     = 'AEBN';
